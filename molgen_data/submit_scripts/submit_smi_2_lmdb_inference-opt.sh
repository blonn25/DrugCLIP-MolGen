...
SMI_FILE=/wynton/group/bks/work/blonn25/software/drugclip_molgen/DrugCLIP-MolGen/molgen_data/inference_output/random_mols/preds_mu_prot_100_repeats_10_samples-opt_0.smi
BASENAME=$(basename "$SMI_FILE" .smi)
OUTPUT_DIR="/wynton/group/bks/work/blonn25/software/drugclip_molgen/DrugCLIP-MolGen/molgen_data/inference_output/random_mols/opt_reencoded"
mkdir -p "$OUTPUT_DIR"
